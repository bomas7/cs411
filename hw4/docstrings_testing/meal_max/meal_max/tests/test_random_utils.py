...
def test_get_random(mock_random_float):
...
def test_get_random_invalid_response(mock_random_float):
    """Simulate  an invalid response (non-digit/number)."""
    mock_random_float.text = "invalid_response"
